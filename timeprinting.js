/* practicing functional programming with ES6 */
/* source From Book LearningReact */
/* DeukwonSeo 20180914 */
...
const startTicking = () => setInterval(compose(clear,getCurrentTime,abstractClockTime,convertToCivilianTime,doubleDigits,formatClock("hh:mm:ss tt"),display(log)), oneSecond())
